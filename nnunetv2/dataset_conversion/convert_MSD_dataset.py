...
def run_main_convert():
    print(33333333333)
    MSD_raw = os.environ['MSD_raw']
    MSD_preprocessed_id = int(os.environ['MSD_preprocessed_id'])
    print(44444444)
    print("MSD_raw is:", MSD_raw)
    print("MSD_preprocessed_id is:", MSD_preprocessed_id)
    convert_msd_dataset(MSD_raw, overwrite_target_id=MSD_preprocessed_id)
